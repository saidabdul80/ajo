<template>
  ...
  <div class="date-range-picker tw-relative" :class="'tw-h-[' + height + '] ' + 'tw-w-[' + width + ']'">
    <InputText :class="['tw-w-full !tw-rounded-2xl !tw-text-base', { '!tw-pl-10': icon }, computedClass]" v-model="displayValue" @click="toggleDropdown" readonly :placeholder="placeholder">
