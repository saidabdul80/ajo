<template>
  <div class="tw-flex tw-items-center tw-justify-between tw-bg-gray-50 tw-px-4 tw-py-1 sm:tw-rounded-lg" >
    ...
    <div class="tw-text-sm tw-text-gray-700">
      ...
      <Button rounded="sm" outlined :disabled="links?.prev === null" @click="changePage(links?.prev)" icon="pi pi-chevron-left" size="small" class="!tw-rounded-md !tw-h-[30px] !tw-w-[30px] !tw-border-gray-400 tw-me-2"  >          
      </Button>
     
      <Button rounded="sm" outlined :disabled="links?.next === null" @click="changePage(links?.next)"  icon="pi pi-chevron-right" size="small" class="!tw-rounded-md !tw-h-[30px] !tw-w-[30px] !tw-border-gray-400 tw-p-0"  >          
      </Button>
    </div>
  </div> 
</template>
