    ...
    <template1>
      <template #content>
        <ion-content color="white">
          <div
            class="!tw-flex tw-flex-col tw-w-full tw-h-[100vh] tw-mt-20 tw-items-center">
            <div class="tw-w-[50%] tw-mt-20">
              <H1 class="tw-font-[600]" text="Welcome back" />
              <span
                class="tw-text-sm tw-mb-8 tw-mt-2 tw-block tw-text-gray-500">
              ...
              <div
                class="tw-flex tw-items-center tw-w-full tw-gap-2 tw-mb-8 tw-justify-between">
                <span
