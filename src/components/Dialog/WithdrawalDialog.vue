<template>
  <div
    v-if="!withdrawalStatus"
    class="tw-flex tw-items-center tw-flex-col tw-gap-3">
    <img
    ...
    <div>
      <h4 class="tw-text-lg tw-text-black tw-font-semibold">
        Fill withdrawal account
      </h4>
      <p class="tw-text-[#333333]">
        The money will be transferred to the account details you fill.
      </p>
  ...
  <div v-if="withdrawalStatus" class="tw-text-center">
    <img
      class="tw-inline-block tw-p-8"
      src="/images/withdrawal-successful.svg"
      alt="icon" />
    <h4 class="tw-text-2xl tw-text-black tw-pb-3">Withdrawal processing...</h4>
    <p class="tw-text-[#333333]">
      Your withdrawal request has been successfully submitted and is being
      processed. You will credited within <b>24 hours.</b>
    </p>
