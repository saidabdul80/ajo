<template>
    <div>
        ...
        <Password :fluid="true"
            :pt="{ root: { style: 'height:' + height }, class: `tw-bg-[${$constants.input_background}] tw-border-[#ccc]` }"
        ...
        <p v-if="displayedErrorMessage" class="tw-text-red-700 tw-text-xs tw-m-1">
