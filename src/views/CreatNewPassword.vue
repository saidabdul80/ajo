          ...
          <ion-content color="white">
            <div class="!tw-flex tw-flex-col tw-w-full tw-h-[100vh] tw-mt-20 tw-items-center">
              <div class="tw-w-[50%] tw-mt-20">
                <H1 class="tw-font-[600]" text="Create new password" />
                <span class="tw-text-[14.3px] tw-mb-8 tw-mt-2 tw-block tw-text-gray-500">
                  Create a new password to sign in later.
                </span>
                ...
                <div class="tw-flex tw-flex-col tw-items-center tw-w-full">
                  ...
                  <span v-if="passwordMismatch" class="tw-text-red-500 tw-text-[12px] tw-mb-4">
                    Passwords do not match
                  </span>
                  <Button label="Continue" size="medium" class="tw-w-full tw-mt-[15px]" />
  
                  <a href="#" class="tw-text-center tw-mt-[10px] tw-text-[14px] tw-font-[600]">
                    Resend code
                  </a>
                </div>
              </div>
